      ...
      <!-- ส่วนของเนื้อหาเเต่ละหน้า -->
        <div class="row">
            ...
            <div class="info-box-content">
              ...
              <div class="progress">
                <div class="progress-bar" style="width: 100%"></div>
                  ...
                  <a href="report_std_table.php" class="btn btn-danger btn-xs ">ดูข้อมูลรายงาน</a>
                  </span>
            </div>
            <!-- /.info-box-content -->
          </div>
          ...
          <div class="info-box bg-yellow">
            ...
            <div class="info-box-content">
              <span class="info-box-text"><h4>กราฟรายงานผล</h4></span>
              <span class="info-box-number"></span>
              ...
              <div class="progress">
                <div class="progress-bar" style="width: 100%"></div>
                  ...
                  <span class="progress-description">
                  <a  class="btn btn-danger btn-xs ">ดูข้อมูลรายงาน</a>
                  </span>
            </div>
            <!-- /.info-box-content -->
          </div>
