                ...
                <div class="box box-primary">
                    ...
                    <div class="row">
                        ...
                        ?>
                            ...
                            <!-- small box -->
                                <div class="small-box <?php if($i%2==0){echo "bg-aqua";}else{echo "bg-teal";}?>">
                                    <div class="inner">
                                    ...
                                    <a href="show_lessonstd.php?id=<?=$row_course['ID_course']?>" class="small-box-footer">
                                    เข้าสู่การเรียนรู้ <i class="fa fa-arrow-circle-right"></i>
                                    </a>
                                </div>
                            </div>
                        <?php
